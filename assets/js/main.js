...
const navbarMenu = document.getElementById('navbar-menu'),
  ...
  navbarClose = document.getElementById('navbar-close-btn');
...
/*=============== REMOVE MENU MOBILE ===============*/
const navbarOptions = document.querySelectorAll('.navbar__option-link');
...
navbarOptions.forEach((option) => option.addEventListener('click', linkAction));
  ...
  emailjs
    ...
    .then(
      () => {
        ...
        // Show sent message
        contactMessage.textContent = "You've reached my inbox! ✅";
...
// Previously selected theme (if user has selected explicitly)
